...
namespace HSVPicker
{
    public class ColorPicker : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool isChangeMain;
        [SerializeField]
        private Image changeMainImage;
        [SerializeField]
        private Image changeServeImage;
        [SerializeField]
        ...
        private void HSVChanged()
        {
            ...
            if (decorationManager.isCustomingMain && isChangeMain)
            {
                changeMainImage.color = color;

                decorationManager.CustomingColor(true);
            }

            if (decorationManager.isCustomingSub && !isChangeMain)
            {
                changeServeImage.color = color;

                decorationManager.CustomingColor(false);
            }
